/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: aa8505426e7fe0f0a1ccf7cd48c25a9d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WORKER_SELF_REFERENCE?: Fetcher /* vtuber-site-template */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "NEXT_PUBLIC_SITE_URL" | "NEXTJS_ENV">> {}
}
